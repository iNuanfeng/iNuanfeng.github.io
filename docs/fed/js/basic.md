...
其中 JS 的数字类型是浮点类型的，没有整型。并且浮点类型基于 IEEE 754标准实现，在使用中会遇到某些 [Bug](/fed/js_basic?id=为什么-01-02-03)。`NaN` 也属于 `number` 类型，并且 `NaN` 不等于自身。
...
### [#](https://yuchengkai.cn/docs/frontend/#比较运算符)比较运算符
...
## [#](https://yuchengkai.cn/docs/frontend/#new)new
...
## [#](https://yuchengkai.cn/docs/frontend/#instanceof)instanceof
...
## [#](https://yuchengkai.cn/docs/frontend/#this)this
...
## [#](https://yuchengkai.cn/docs/frontend/#执行上下文)执行上下文
...
[![img](https://yck-1254263422.cos.ap-shanghai.myqcloud.com/blog/2019-06-01-167eda3ea0ecfa58.png)ZOOM 前端架构师黄轶, 国内 CSS 专家一丝姐推荐](https://juejin.im/book/5bdc715fe51d454e755f75ef?referrer=574f8d8d2e958a005fd4edac)

## [#](https://yuchengkai.cn/docs/frontend/#闭包)闭包
...
## [#](https://yuchengkai.cn/docs/frontend/#深浅拷贝)深浅拷贝
...
### [#](https://yuchengkai.cn/docs/frontend/#浅拷贝)浅拷贝
...
### [#](https://yuchengkai.cn/docs/frontend/#深拷贝)深拷贝
...
## [#](https://yuchengkai.cn/docs/frontend/#模块化)模块化
...
### [#](https://yuchengkai.cn/docs/frontend/#commonjs)CommonJS
...
### [#](https://yuchengkai.cn/docs/frontend/#amd)AMD
...
## [#](https://yuchengkai.cn/docs/frontend/#防抖)防抖
...
## [#](https://yuchengkai.cn/docs/frontend/#节流)节流
...
## [#](https://yuchengkai.cn/docs/frontend/#继承)继承
...
## [#](https://yuchengkai.cn/docs/frontend/#call-apply-bind-区别)call, apply, bind 区别
...
### [#](https://yuchengkai.cn/docs/frontend/#模拟实现-call-和-apply)模拟实现 call 和 apply
...
## [#](https://yuchengkai.cn/docs/frontend/#promise-实现)Promise 实现
...
## [#](https://yuchengkai.cn/docs/frontend/#generator-实现)Generator 实现
...
## [#](https://yuchengkai.cn/docs/frontend/#map、flatmap-和-reduce)Map、FlatMap 和 Reduce
...
## [#](https://yuchengkai.cn/docs/frontend/#async-和-await)async 和 await
...
## [#](https://yuchengkai.cn/docs/frontend/#proxy)Proxy
...
## [#](https://yuchengkai.cn/docs/frontend/#为什么-0-1-0-2-0-3)为什么 0.1 + 0.2 != 0.3
...
## [#](https://yuchengkai.cn/docs/frontend/#正则表达式)正则表达式

### [#](https://yuchengkai.cn/docs/frontend/#元字符)元字符
...
### [#](https://yuchengkai.cn/docs/frontend/#修饰语)修饰语
...
### [#](https://yuchengkai.cn/docs/frontend/#字符简写)字符简写
...
## [#](https://yuchengkai.cn/docs/frontend/#v8-下的垃圾回收机制)V8 下的垃圾回收机制

V8 实现了准确式 GC，GC 算法采用了分代式垃圾回收机制。因此，V8 将内存（堆）分为新生代和老生代两部分。

### [#](https://yuchengkai.cn/docs/frontend/#新生代算法)新生代算法

新生代中的对象一般存活时间较短，使用 Scavenge GC 算法。

在新生代空间中，内存空间分为两部分，分别为 From 空间和 To 空间。在这两个空间中，必定有一个空间是使用的，另一个空间是空闲的。新分配的对象会被放入 From 空间中，当 From 空间被占满时，新生代 GC 就会启动了。算法会检查 From 空间中存活的对象并复制到 To 空间中，如果有失活的对象就会销毁。当复制完成后将 From 空间和 To 空间互换，这样 GC 就结束了。

### [#](https://yuchengkai.cn/docs/frontend/#老生代算法)老生代算法
